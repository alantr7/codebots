    ...
    public CompletableFuture<Void> fetchSession(EditorSession session) {
        ...
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                var lastChangeTimestamp = (Long) MathUtils.any(responseSession.get("last_modified"), 0L);
                ...
                filesArray.forEach(fileJsonObject -> {
                    ...
                    var fileLastChangeTimestamp = (Long) MathUtils.any(fileJson.get("last_modified"), 0L);
